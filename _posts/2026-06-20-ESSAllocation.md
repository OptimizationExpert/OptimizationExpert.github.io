---
layout: post
title: "پروژه: جایابی بهینه ذخیره‌ساز انرژی برای کاهش هدر تجدیدپذیرها"
date: 2026-06-20
...
**سطح:** پیشرفته | **زمان:** ۱۲-۱۶ هفته | **ابزار:** Python (Pyomo) یا GAMS
...
- خلاصه آماری داده‌ها (میانگین، انحراف معیار، peak)
...
**اهداف:**
- پیاده‌سازی مسئله‌ی پخش‌بار اقتصادی (EDC) بدون ذخیره‌ساز
- تعیین خط‌پایه (baseline) برای مقایسه
...
- نقاط تنگنا در شبکه (congestion points)
...
**اهداف:**
- اجرای مدل روی یک شبکه کوچک و ساده (۳-۵ نقطه)
...
### **تحویل ۸: حل برای شبکه واقعی (۳۰-۱۱۸ نقطه)**
