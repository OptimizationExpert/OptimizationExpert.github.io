...
نگاشتِ مدل ریاضی به کد در ابزارهای استاندارد: Pyomo و Gurobi در Python و JuMP در Julia. یاد می‌گیرید ساختار مدل ریاضی چطور یک‌به‌یک به مجموعه‌ها، پارامترها، متغیرها و قیود در کد نگاشت می‌شود.
...
<script type="application/ld+json">
{
  ...
  "teaches": [
    ...
    "نگاشت مدل ریاضی به کد در Pyomo، Gurobi و JuMP"
  ],
  "provider": {
