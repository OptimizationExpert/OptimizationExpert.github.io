...
<script type="application/ld+json">
{
  ...
  "description": "دوره پایه مدل‌سازی مسائل بهینه‌سازی: تبدیل مسائل واقعی به مدل ریاضی، تعریف متغیر تصمیم، تابع هدف و قیود، انواع مسائل LP/MILP/NLP و آمادگی برای کدنویسی با.",
  "inLanguage": "fa",
