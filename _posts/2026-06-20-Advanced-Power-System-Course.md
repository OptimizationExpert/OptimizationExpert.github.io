...
**محیط کار:** Python  |  **سطح:** پیشرفته  |  **تعداد مباحث:** ۱۰
...
## فاز ۱ — آرایش بهینه واحدها (Unit Commitment)
...
## فاز ۲ — پخش بار DC و قیود امنیت N-1
...
## فاز ۴ — جایابی باتری در شبکه انتقال (DC-OPF + Storage)
...
## فاز ۵ — مدیریت مصرف در شبکه انتقال (Demand Response)
...
## فاز ۶ — برنامه‌ریزی توسعه شبکه انتقال (TEP)
...
## فاز ۷ — بهینه‌سازی چندهدفه با پخش بار DC
...
## فاز ۸ — عدم قطعیت در آرایش بهینه واحدها (بدون قیود شبکه)
...
## فاز ۹ — سوئیچینگ بهینه خطوط انتقال (Optimal Transmission Switching)
...
## فاز ۱۰ — کنترل پیوسته توان راکتیو منابع خورشیدی در شبکه توزیع (Inverter Volt/VAR Optimization)
