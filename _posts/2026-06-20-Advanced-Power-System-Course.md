...
در این دوره پیشرفته آموزش بهینه‌سازی سیستم‌های قدرت در پایتون، با تدریس دکتر علی سرودی، به صورت کاملاً کاربردی با مدل‌سازی مسائل کلیدی صنعت برق مانند آرایش بهینه واحدها (Unit Commitment)، پخش بار بهینه (OPF) و برنامه‌ریزی توسعه شبکه با استفاده از  Pyomo  آشنا می‌شوید.
