...
همین ساختار در گام‌های بعد با افزودن زمان، شبکه و باتری گسترش می‌یابد. اگر می‌خواهید این کد را بدون نصب چیزی روی سیستم خودتان اجرا کنید، راهنمای [Google Colab](/notes/google-colab/) کمک می‌کند؛ و برای آشنایی با گزینه‌های مختلف سالور در Pyomo، یادداشت [سه روش عملی استفاده از سالورها](/notes/pyomo-solvers/) را ببینید.
