...
## بخش ۶ — برنامه‌ریزی توسعه شبکه انتقال و تولید (TGEP)

در این دوره یاد می‌گیرید چطور یک مسئله‌ی واقعی برنامه‌ریزی سرمایه‌گذاری شبکه برق را از صفر در پایتون (Pyomo) مدل و حل کنید؛ نه یک محاسبه‌ی لحظه‌ای، بلکه یک تصمیم چندساله:
در افق ۱۰ ساله، با رشد سالانه‌ی بار، مدل باید تصمیم بگیرد **در چه سالی** کدام نیروگاه یا خط انتقال کاندید ساخته شود — نه فقط «کجا» بلکه «چه زمانی»، با متغیرهای باینری سرمایه‌گذاری.

هزینه‌های آینده با **نرخ تنزیل (Discount Rate / NPV)** به ارزش امروز تبدیل می‌شوند تا مقایسه‌ی هزینه‌ی سرمایه‌گذاری در سال‌های مختلف منصفانه باشد.
یک متغیر حیاتی دیگر، **بار حذف‌شده (Load Shedding)** با هزینه‌ی VOLL است: مدل باید بین ساختن زیرساخت جدید (هزینه‌ی سرمایه‌ای) و پذیرفتن ریسک خاموشی (هزینه‌ی قابلیت اطمینان) به‌صورت اقتصادی تصمیم بگیرد.

نتیجه یک مدل **MILP کامل** روی پایه‌ی DC-OPF است که تولید و انتقال را هم‌زمان، برای کل افق برنامه‌ریزی، بهینه می‌کند — دقیقاً مدلی که شرکت‌های برق برای تصمیم‌های سرمایه‌گذاری واقعی از آن استفاده می‌کنند.
...
## بخش ۸ — عدم قطعیت در آرایش بهینه تولید واحدها 
