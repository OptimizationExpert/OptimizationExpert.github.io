...
![طیف روش‌های مدل‌سازی عدم قطعیت از Stochastic تا IGDT](./uncertainty-spectrum.webp)
...
آشنایی با مدل‌سازی مسائل بهینه‌سازی (متغیر، هدف، قید) و برنامه‌نویسی پایه Python توصیه می‌شود. در صورت نیاز، ابتدا دوره [مدل‌سازی مسائل بهینه‌سازی](/courses/optimization-modeling/) پیشنهاد می‌شود.
