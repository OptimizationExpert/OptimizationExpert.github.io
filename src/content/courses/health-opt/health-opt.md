...
- توضیح خط‌به‌خط متغیر انتخاب/عدم‌انتخاب هر بیمار در کنار قید مدار جزئی (partial circuit) که توالی را فقط بین بیماران
  انتخاب‌شده می‌بندد
...
- توضیح خط‌به‌خط متغیر سطح باتری در طول مسیر (کاهش با هر یال سفر، افزایش با توقف در ایستگاه شارژ) و قید عدم
  منفی‌شدن باتری در هیچ نقطه‌ای از مسیر
- درج اختیاری هر ایستگاه شارژ در مسیر (شبیه توقف‌های اختیاری) با زمان توقف متناسب با مقدار شارژ دریافتی، به‌همراه
