...
Python است. دوره شامل **۲۰ پروژه‌ی عملی** و حدود **۱۲ ساعت ویدیوی آموزشی** است. همه‌ی پروژه‌ها با کتابخانه‌ی
**OR-Tools** و سالور **CP-SAT** پیاده‌سازی شده‌اند و از سطح مقدماتی (تخصیص و موجودی) آغاز می‌شوند و به‌تدریج وارد مسائل
ترکیبی‌تر برنامه‌ریزی حرکت پرسنل، زمان‌بندی منابع درمانی، و در نهایت یک پروژه‌ی جمع‌بندی با محوریت امداد پهپادی می‌شوند.
...
**چرا مهم است —** هزینه‌ی غذای بیمارستانی سرشکن روی هزاران وعده در سال است؛ حتی صرفه‌جویی جزئی روزانه، در مقیاس سالانه
رقم بزرگی می‌شود.
...
**چرا مهم است —** تخصیص نامناسب پرستار به بیمار (مثلاً پرستار بدون مهارت مراقبت ویژه برای بیمار ICU) مستقیماً روی کیفیت
و ایمنی مراقبت اثر می‌گذارد.
...
**چرا مهم است —** کیسه‌ی خون یک کالای فسادپذیر و گاهی کمیاب است؛ مدیریت ضعیف موجودی یعنی یا کمبود در بحران یا دورریز
پرهزینه.
...
**چرا مهم است —** در روزهای پرفشار، تخصیص عادلانه و اولویت‌بندی‌شده‌ی تخت‌های محدود ICU می‌تواند تفاوت میان زندگی و مرگ
باشد.
...
**چه یاد می‌گیرید —** مسئله‌ی کلاسیک Facility Location: کدام مراکز باز شوند تا با کمترین هزینه، بیشترین جمعیت پوشش داده
شود.
...
**چرا مهم است —** ازدحام اورژانس یکی از رایج‌ترین علل نارضایتی بیمار و تأخیر درمان است؛ شناخت گلوگاه‌های جریان، اولین
قدم رفع آن است.
...
**چرا مهم است —** تطبیق درست اهداکننده و گیرنده‌ی عضو، هم شانس موفقیت پیوند را بالا می‌برد و هم لیست انتظار را
منصفانه‌تر مدیریت می‌کند.
...
**چرا مهم است —** اتاق عمل گران‌ترین و کمیاب‌ترین منبع بیمارستانه؛ زمان‌بندی ضعیف یعنی جراحی‌های قابل‌انجام بدون دلیل
واقعی عقب می‌افتن، در حالی که ظرفیت اتاق و جراح به‌درستی تخصیص نیافته.
...
### <i class="fa-solid fa-scale-balanced"></i> پروژه ۹— عدالت گستری در تخصیص شیفت ها با قید پنجره‌ی غلتان

**چرا مهم است —** تمرکز نامتناسب شیفت‌های شب در یک بازه‌ی کوتاه، یا نبودِ استراحت کافی در یک بازه‌ی طولانی‌تر، خستگی
تجمعی پرستار را بالا می‌برد؛ عدالت باید هم در کل بازه‌ی برنامه‌ریزی و هم در بازه‌های محلی کوتاه و بلند رعایت شود.

**چه یاد می‌گیرید —** ترکیب سه قید مکمل: یک قید پنجره‌ی غلتان کوتاه که مجموع شیفت‌های شب را در هر پنج روز متوالی محدود
می‌کند؛ یک قید پنجره‌ی غلتان بلندتر که حداقل تعداد تعطیلی را در هر هفت روز متوالی تضمین می‌کند؛ و یک قید بیشینه-کمینه که
به‌جای شمارش کل شیفت‌ها، فقط بیشترین بار کاری شبانه‌ی هر پرستار را در کل افق کمینه می‌کند — یعنی هدف از «بیشینه‌کردن
...
**چرا مهم است —** یک پرستار مراقبت در منزل هرچه توالی بهتری برای بازدیدهای روزانه‌اش داشته باشد، ویزیت‌های بیشتری در
همان زمان انجام می‌دهد.
...
### <i class="fa-solid fa-weight-hanging"></i> پروژه ۱۱ — برنامه‌ریزی حرکت با ظرفیت (Capacitated Home Care Planning)

**چرا مهم است —** هر پرستار در یک روز کاری، ظرفیت محدودی از تعداد ویزیت یا زمان دارد؛ نادیده‌گرفتن این محدودیت یعنی
برنامه‌ی غیرقابل‌اجرا.
...
### <i class="fa-solid fa-hourglass-half"></i> پروژه ۱۲ — برنامه‌ریزی حرکت با پنجره‌ی زمانی (Home Care with Time Windows)

**چرا مهم است —** بسیاری از بیماران فقط در بازه‌ی زمانی مشخصی (مثلاً قبل از کار یا بعد از مدرسه‌ی فرزندشان) در
دسترس‌اند.
...
### <i class="fa-solid fa-people-arrows"></i> پروژه ۱۳ — تخصیص و توالی چندمهارتی (Multi-Skill Home Care)
...
### <i class="fa-solid fa-truck-medical"></i> پروژه ۱۴ — اعزام و برنامه‌ریزی حرکت آمبولانس (Ambulance Dispatch)
...
### <i class="fa-solid fa-right-left"></i> پروژه ۱۵ — انتقال بیمار بین بیمارستان‌ها (Inter-Hospital Transfer)
...
**چه یاد می‌گیرید —** زمان‌بندی نوبت‌ها با در نظر گرفتن احتمال عدم‌حضور بیمار (no-show) — یک تکنیک واقعی صنعت درمان برای
موازنه‌ی ریسک.
...
**چرا مهم است —** بخش شیمی‌درمانی معمولاً تعداد صندلی محدود دارد و هر جلسه‌ی درمان مدت‌زمان متفاوتی می‌برد؛ برنامه‌ریزی
بد یعنی انتظار طولانی برای بیماران آسیب‌پذیر.
...
**چرا مهم است —** برخی داروها و واکسن‌ها باید در محدوده‌ی دمایی مشخص نگه‌داری شوند؛ نقض این زنجیره یعنی از دست رفتن کل
محموله.
...
**چرا مهم است —** در بحران‌های بزرگ (پاندمی، بلایا)، تخصیص روزانه‌ی تخت/اکسیژن/واکسن بین چند منطقه باید سریع و منصفانه
انجام شود.
...
**چرا مهم است —** بعد از زلزله یا سیل، جاده‌ها اغلب مسدودند؛ پهپاد می‌تواند سریع‌تر و بدون وابستگی به زیرساخت، محموله‌ی
پزشکی به مناطق قطع‌شده برساند.
