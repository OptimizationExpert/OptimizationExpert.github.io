...
Python است. دوره شامل **۲۰ پروژه‌ی عملی** و حدود **۳۵ ساعت ویدیوی آموزشی** است. همه‌ی پروژه‌ها با کتابخانه‌ی
...
* تحلیل حساسیت: تغییر پارامتر ورودی به مساله و یا قیود آن باعث چه تغییری در خروجی میشود؟
...
### <i class="fa-solid fa-charging-station"></i> پروژه ۱۷ — مسیریابی خودروهای الکتریکی تیم شیمی‌درمانی سیار با ایستگاه شارژ (Electric VRP with Charging Stations)
...
![تامین نیاز مناطق بر حسب زمان و بررسی تاب آوری سیستم استفاده از پایتون](./resilience.webp)


### <i class="fa-solid fa-helicopter"></i> پروژه ۲۰ — امداد پهپادی به مناطق آسیب‌دیده (Disaster-Relief Drone Dispatch)

**دقیقاً چه مسئله‌ای قرار است حل شود —** یک پهپاد شناسایی/عکاسی با برد باتری محدود داریم که باید از چند منطقه‌ی آسیب‌دیده با اولویت مشخص عکس‌برداری کند. پهپاد می‌تواند در طول روز چند پرواز جداگانه انجام دهد (بین پروازها به پایگاه برمی‌گردد)، اما هر پرواز به‌تنهایی نباید از برد باتری تجاوز کند و مجموع زمان همه‌ی پروازهای روز نباید از یک بودجه‌ی روزانه‌ی مشخص (مثلاً ۸ ساعت) بیشتر شود. زمان پرواز بین هر دو نقطه لزوماً یکسان نیست — به‌دلیل وزش باد، رفتن و برگشتن بین دو نقطه ممکن است زمان متفاوتی ببرد. باید مشخص شود پهپاد در هر پرواز به کدام مناطق برود و با چه توالی، طوری‌که مجموع اولویت مناطق پوشش‌داده‌شده بیشینه شود.
...
* توضیح خط‌به‌خط مدل تخصیص + توالی + قید سطح باتری (شبیه پروژه‌ی خودروی الکتریکی)
* تحلیل حساسیت: تغییر پارامتر ورودی به مساله و یا قیود آن باعث چه تغییری در خروجی میشود؟
...
* ویدیوهای آموزشی گام‌به‌گام (حدود ۳۵ ساعت)
...
<p>۲۰ پروژه عملی (۸ پروژه پایه و ۱۲ پروژه تخصصی حوزه سلامت)، حدود ۳۵ ساعت ویدیو، کد کامل، قالب اکسل آماده، تحلیل حساسیت و ویژوالیزیشن هر پروژه.</p>
