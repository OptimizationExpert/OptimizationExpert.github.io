...
![مدل حداکثر جریان شبکه با پایتون و OR-Tools](./project_1_maxflow.webp)
...
![مدل تخصیص کارگر به وظیفه با برنامه‌ریزی محدودیت در پایتون](./project_2_assignment.webp)
...
![مدل کوله‌پشتی و بسته‌بندی چندسطلی با CP-SAT](./project_3_binpacking.webp)
...
![مدل چیدمان میهمانان عروسی با بهینه‌سازی ترکیبی در پایتون](./project_4_wedding.webp)
...
![نمودار گانت زمان‌بندی تولید کارگاهی با CP-SAT](./project_5_jobshop.webp)
...
![مسیریابی تحویل بار فرودگاه با چند ون در پایتون](./project_6_airport_routing.webp)
...
![حل مربع جادویی با برنامه‌ریزی محدودیت CP-SAT](./project_7_magicsquare.webp)
...
![یافتن بزرگ‌ترین خوشه گراف با CP-SAT و networkx](./project_8_maxclique.webp)
...
![برنامه‌ریزی متوازن تقویم درسی BACP با پایتون](./project_9_curriculum.webp)
...
![جانمایی بهینه ربات‌ها با هدف max-min در CP-SAT](./project_10_robotplacement.webp)
...
![نمونه خروجی مسیریابی وسایل نقلیه با پایتون و OR-Tools](./TDvrp.webp)
...
![حل مسئله فروشنده دوره‌گرد TSP با AddCircuit در OR-Tools](./project_11_tsp.webp)
...
![مسیر انتخابی TSP با قید ترتیب بازدید در پایتون](./project_12_selectivetsp.webp)
...
![مسیریابی ظرفیت‌دار چندخودرویی CVRP با پایتون](./project_13_cvrp.webp)
...
![مسیریابی چندانباره Multi-Depot VRP با CP-SAT](./project_14_multidepot.webp)
...
![تحویل تقسیم‌شده Split Delivery VRP با پایتون](./project_15_splitdelivery.webp)
...
![مسیریابی با پنجره زمانی VRPTW در پایتون](./project_16_vrptw.webp)
...
![مسیریابی خودروی برقی EV Routing با محدودیت باتری](./project_17_evrouting.webp)

تصویر بالا مسیر خودروی برقی و ایستگاه شارژ میان‌راهی برای تمدید برد را نشان می‌دهد.
...
![حل پازل Zip لینکدین با مسیر همیلتونی در پایتون](./project_18_zippuzzle.webp)
...
![مدل ترابری و انتقال بار Transshipment در مسیریابی](./project_19_transshipment.webp)
...
![مسیریابی موجودی چندروزه Inventory Routing با پایتون](./project_20_inventoryrouting.webp)
...
آشنایی پایه با Python کافی است. آشنایی قبلی با مدل‌سازی مسائل بهینه‌سازی توصیه می‌شود اما الزامی نیست؛ در صورت نیاز ابتدا دوره [مدل‌سازی مسائل بهینه‌سازی](/courses/optimization-modeling/) پیشنهاد می‌شود. اگر پس از این دوره می‌خواهید به سراغ مسائلی با پارامترهای نامطمئن (مثل تقاضای غیرقطعی مشتریان) بروید، دوره [مدل‌سازی عدم‌قطعیت](/courses/uncertainty-modeling/) گام بعدی طبیعی است.
