...
seoTitle: "آموزش پیشرفته بهینه‌سازی سیستم قدرت با پایتون و Pyomo | دوره پروژه‌محور"
...
مدل ساده‌شده، خطی و سریع شبکه برای استفاده در مسائل بهینه‌سازی بزرگ. ابتدا منطق و فرض‌های مدل DC مرور می‌شود، سپس معیار امنیت N-1 معرفی می‌گردد: شبکه باید بتواند خروج هر یک عضو (خط یا ترانس) را بدون اضافه‌بار شدن خطوط دیگر تحمل کند. برای کارایی محاسباتی، استفاده از ضرایب حساسیت آماده (PTDF و LODF) آموزش داده می‌شود. هم‌چنین بارگذاری خطوط در حالت عادی و در سناریوهای خروج N-1 بررسی می شود تا خطوط بحرانی مشخص شوند.
