...
![نمودار آرایش بهینه واحدها و سهم تولید در طول شبانه‌روز](./01_unit_commitment.webp)
...
![مقایسه پخش بار DC در حالت عادی و سناریوی امنیت N-1](./02_dc_opf_n1.webp)
...
![پروفایل ولتاژ باس‌ها و مقایسه مدل AC و DC](./03_ac_opf.webp)
...
![جایابی بهینه باتری در شبکه انتقال و الگوی شارژ و دشارژ](./04_battery_placement.webp)
...
![مقایسه پروفایل بار پیش و پس از مدیریت مصرف](./05_demand_response.webp)
...
![برنامه‌ریزی توسعه شبکه انتقال و انتخاب خطوط کاندید](./06_tep.webp)
...
![جبهه پارتو برای مصالحه میان هزینه و آلودگی](./07_pareto.webp)
...
![عدم قطعیت در آرایش بهینه واحدها با رویکرد سناریومحور](./08_stochastic_uc.webp)
برای آشنایی عمیق‌تر با روش‌های مدل‌سازی عدم قطعیت مانند رویکردهای تصادفی، فازی، مقاوم و IGDT، می‌توانید [دوره مدل‌سازی عدم قطعیت](/courses/uncertainty-modeling/) را نیز ببینید.
...
![مقایسه شبکه پیش و پس از سوئیچینگ بهینه خطوط انتقال](./09_transmission_switching.webp)
...
![کنترل Volt VAR اینورترها و بهبود پروفایل ولتاژ شبکه توزیع](./10_volt_var.webp)
