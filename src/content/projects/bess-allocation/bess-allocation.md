...
تصویر بالا نمونه‌ای ساده از یک شبکه انتقال را نشان می‌دهد؛ نقاط کرال، مکان‌های کاندید برای نصب باتری هستند که معمولاً
نزدیک باس‌های دارای تولید تجدیدپذیر یا گلوگاه‌های شبکه انتخاب می‌شوند.
...
۱. **مطالعه ادبیات:** جستجو برای مقالات درباره Energy Storage Placement ۲. **انتخاب شبکه‌ی تست:** از IEEE Test Cases
استفاده کن (IEEE 30-Bus, IEEE 118-Bus)
...
فراتر از سناریوهای قطعی بروید و عدم‌قطعیت تولید تجدیدپذیر یا قیمت برق را هم صریح در مدل وارد کنید،
