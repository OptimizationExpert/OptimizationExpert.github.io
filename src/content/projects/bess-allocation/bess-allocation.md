---
title: "جایابی باتری برای کاهش هدررفت تجدیدپذیرها"
...
اگر با مبانی مدل‌سازی ریاضی مسائل بهینه‌سازی آشنا نیستید، دوره [مدل‌سازی مسائل بهینه‌سازی](/courses/optimization-modeling/) پیش‌زمینه‌ی خوبی می‌دهد.

![جایابی کاندید ذخیره‌ساز انرژی در شبکه انتقال](./bess-network.webp)
...
پیش از شروع کدنویسی، مرور یادداشت [مدل‌سازی ریاضی و اهمیت آن](/notes/mathematical-modeling-art/) کمک می‌کند مسئله را درست فرموله کنید. برای اجرای کد بدون نصب چیزی روی سیستم خودتان، راهنمای [Google Colab](/notes/google-colab/) و برای انتخاب سالور مناسب، یادداشت [سه روش عملی استفاده از سالورها در Pyomo](/notes/pyomo-solvers/) را ببینید. اگر می‌خواهید فراتر از سناریوهای قطعی بروید و عدم‌قطعیت تولید تجدیدپذیر یا قیمت برق را هم صریح در مدل وارد کنید، دوره [مدل‌سازی عدم‌قطعیت](/courses/uncertainty-modeling/) ابزار لازم را می‌دهد.
