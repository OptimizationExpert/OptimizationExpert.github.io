...
فرض کنید **سازمان بازرسی گوشت کشور** قصد دارد برای بازبینی و کنترل قصابی‌های **استان البرز** در طول یک سال برنامه‌ریزی کند. پیش از ورود به جزئیات، مرور یادداشت [مدل‌سازی ریاضی و اهمیت آن](/notes/mathematical-modeling-art/) کمک می‌کند این مسئله را به شکل درستی به یک مدل ریاضی تبدیل کنید.
...
اگر یک بازرس یا خودرو در یک شیفت چند بازرسی انجام دهد، باید زمان جابه‌جایی هم لحاظ شود. این یعنی علاوه بر مدت خود بازرسی‌ها، زمان لازم برای حرکت از محل یک بازرسی به محل بازرسی بعدی هم در برنامه بیاید.
...
اگر می‌خواهید مدل‌سازی و حل کامل را در Python با OR-Tools قدم‌به‌قدم یاد بگیرید، این موضوع در <a href="/courses/vrp-python/" class="content-link">دوره بهینه‌سازی حمل و نقل </a> به‌صورت پروژه‌محور پوشش داده شده است.  [Google Colab](/notes/google-colab/) کمک می‌کند؛ و اگر بخواهید به‌جای OR-Tools از یک مدل خطی در Pyomo استفاده کنید، یادداشت [سه روش عملی استفاده از سالورها در Pyomo](/notes/pyomo-solvers/) را ببینید.
