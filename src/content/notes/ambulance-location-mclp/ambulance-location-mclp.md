...
pubDate: 2026-08-16
author: "dr-soroudi"
minimalImage: "./ambulance-location-mclp-mini.webp"
...
پس از تعیین محل ایستگاه‌ها، تصمیم بعدی این است که هر آمبولانس در چه ترتیب و زمانی به تماس‌ها سرویس بدهد؛ این دقیقاً همان چیزی است که در یادداشت [مسئله مسیریابی وابسته به زمان](/notes/time-dependent-vrp/) و دوره آموزشی [مسیریابی و زمان‌بندی با پایتون](/courses/vrp-python/) به‌طور دقیق بررسی شده است.
