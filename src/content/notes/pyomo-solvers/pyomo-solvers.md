...
وقتی می‌خوای با Pyomo مدل‌سازی کنی، اول باید یک **Solver** داشته باشی. مسئله اینه که خیلی از solverهای خوب (Gurobi، CPLEX) رایگان نیستن. ولی خیلی راهکار رایگان و قابل‌اعتماد هم هست. اینجا سه تا بهترین گزینه رو معرفی می‌کنم. (اگر هنوز با مفهوم مدل‌سازی ریاضی پیش از انتخاب سالور آشنا نیستید، یادداشت [مدل‌سازی ریاضی و اهمیت آن](/notes/mathematical-modeling-art/) را ببینید.)
...
اگر نمی‌خوای چیزی نصب کنی یا سیستمت ضعیفه، Google Colab بهترین گزینه است (برای بررسی کامل مزایا و معایب Colab، یادداشت [Google Colab: مزایا و معایب](/notes/google-colab/) را ببینید).
