...
**برنامه‌ریزی محدودیت** یا Constraint Programming برای چنین مسائلی بسیار مناسب است؛ زیرا می‌توانیم قواعد مسئله را مستقیماً به مدل بدهیم و سالور، آرایش‌های نامعتبر را بدون بررسی کامل کنار بگذارد.

در این مطلب از سالور **CP-SAT** در کتابخانه‌ی OR-Tools استفاده می‌کنیم.
...
با این هدف، سالور در میان تمام جواب‌های معتبر، آرایشی را انتخاب می‌کند که بیشترین تعداد دومینوی عمودی را داشته باشد.
