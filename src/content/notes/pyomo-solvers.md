...
⚠️ **نکته مهم:** ورژن Python و Anaconda مهمه. اگر از یک نسخه‌ی خیلی جدید استفاده کنی و بعدش مشکل پیش بیاد، دوباره نصب هم سخت خواهد بود. بهتره از ورژن Python **۳.۷ یا ۳.۹** شروع کنی.
