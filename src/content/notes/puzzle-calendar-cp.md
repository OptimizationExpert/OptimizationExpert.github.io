...
pubDate: 2026-08-08
author: "علیرضا سرودی"
image: "/images/notes/puzzle_calendar_base.webp"
...
![قطعات پازل](/images/notes/puzzle_calendar_0.webp)

من سعی کردم این مسئله را با برنامه‌ریزی محدودیتی حل کنم.
...
![یک نمونه چیدمان پازل تقویم](/images/notes/puzzle_calendar_1.webp)
...
![صفحه بازی با مختصات و مقادیر هر خانه](/images/notes/puzzle_calendar_2.webp)
...
* **تحقیقات الگوریتمی و آموزش:** استفاده از پازل‌هایی مثل این به‌عنوان بستر آزمایش کارایی حل‌کننده‌های CP-SAT و مقایسه روش‌های مدل‌سازی محدودیت.

از کد خواستم چند چیدمان برای روزهای ماه سپتامبر پیدا کند.

![یک نمونه چیدمان پازل تقویم برای سپتامبر](/images/notes/puzzle_calendar_3.webp)
