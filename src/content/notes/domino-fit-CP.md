...
description: "حل مساله پازل به همراه فرمولاسیون و کد نویسی در ORTools"
pubDate: 2026-08-05
author: "علیرضا سرودی"
...
دو مجموعه متغیر دودویی تعریف می‌کنیم.
...
در یک شبکه‌ی \(5 \times 5\)، در نگاه اول ممکن است تصور کنیم به ۲۵ متغیر عمودی و ۲۵ متغیر افقی نیاز داریم.
...
در یک نمونه‌ی \(5 \times 5\)، ممکن است پس از حذف موقعیت‌های غیرمجاز تنها متغیرهای زیر باقی بمانند:
...
بنابراین محدودیت پوشش به‌صورت زیر نوشته می‌شود:
...
همین ساختار را می‌توان از یک پازل \(5 \times 5\) تا مسائل واقعی جانمایی، بارگیری، انبارداری و زمان‌بندی توسعه داد.
