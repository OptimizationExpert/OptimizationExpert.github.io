...
**بهینه‌سازی مقاوم (Robust Optimization).** در این رویکرد، عدم‌قطعیت با یک «مجموعه عدم‌قطعیت» تعریف می‌شود و راه‌حل به‌دست‌آمده باید برای بدترین حالت ممکن در آن مجموعه هم بهینه یا دست‌کم شدنی (Feasible) بماند. با استفاده از فرمول‌بندی دوگان، این مسئله دو سطحی و به‌ظاهر پیچیده را می‌توان به یک مسئله بهینه‌سازی خطی معمولی و قابل‌حل تبدیل کرد.
