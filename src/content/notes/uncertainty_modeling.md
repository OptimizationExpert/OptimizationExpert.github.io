...
pubDate: 2026-08-12
author: "علیرضا سرودی"
image: "/images/notes/uncertainty_thumb.webp"
...
مقاومت تصمیم $\bar{d}$ نسبت به الزام $\zeta$، بیشینه مقدار $\alpha$ است که در آن قیود مسئله هنوز نقض نمی‌شوند، و مسئله نهایی تصمیم‌گیری به‌صورت زیر است:
...
**بهینه‌سازی مقاوم (Robust Optimization).** عدم‌قطعیت با یک «مجموعه عدم‌قطعیت» تعریف می‌شود و راه‌حل باید برای بدترین حالت ممکن در آن مجموعه نیز بهینه/شدنی بماند. با گرفتن دوگان زیرمسئله بدترین‌حالت، فرم نهایی به یک مسئله خطی و قابل‌حل تبدیل می‌شود؛ متغیرهای کمکی $\beta$ و $\xi_i$ نقش دوگان متغیر شارژ $w_i$ را می‌گیرند و باید نامنفی باشند:

$$\max_{y,\xi_i,\beta} z \quad \text{s.t.}\quad z\le f(x,z),\quad f(x,y)=A(y)\bar{x}+g(y)-\Gamma\beta-\sum_i \xi_i,\quad \beta+\xi_i \ge A(y_i)\hat{x}_i,\quad \beta,\ \xi_i \ge 0$$

![انواع روش های مدلسازی عدم قطعیت](/images/notes/uncertainty_category.webp)
