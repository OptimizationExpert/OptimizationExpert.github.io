...
$$\max_{y,\xi_i,\beta} z \quad \text{s.t.}\quad z\le f(x,z),\quad f(x,y)=A(y)\bar{x}+g(y)-\Gamma\beta-\sum_i \xi_i,\quad \beta+\xi_i \ge A(y_i)\hat{x}_i,\quad \sum_i w_i\le\Gamma$$
