...
![نقشه مفهومی مکان‌های کاندید انبار، مشتریان و مسیرهای تأمین انتخاب‌شده](./facility-location-problem.webp)
...
اگر همین حالا حس می‌کنید مدل‌سازی با CP-SAT و برنامه‌ریزی محدودیت برایتان جذاب است، دوره [مسیریابی و بهینه‌سازی با پایتون](/courses/vrp-python/) دقیقاً همین رویکرد را از پایه آموزش می‌دهد و می‌تواند نقطه شروع خوبی برای تسلط روی این نوع مسائل شبکه‌ای در زنجیره تأمین باشد.
